...
/**
 * Captures all search flags from the CLI into a single object
 * passed through the search pipeline.
 */
public class QueryOptions {
    ...
    public String  getFilterExt()          { return filterExt; }
    public Long    getMinSizeBytes()       { return minSizeBytes; }
    public Long    getModifiedAfterEpoch() { return modifiedAfterEpoch; }

    public boolean hasExtFilter()          { return filterExt != null; }
    public boolean hasSizeFilter()         { return minSizeBytes != null; }
    public boolean hasDateFilter()         { return modifiedAfterEpoch != null; }
    ...
    public static class Builder {
        ...
        public Builder(String rawQuery) { this.rawQuery = rawQuery; }

        public Builder fuzzy(boolean v)              { this.fuzzy  = v; return this; }
        public Builder prefix(boolean v)             { this.prefix = v; return this; }
        public Builder phrase(boolean v)             { this.phrase = v; return this; }
        public Builder filterExt(String v)           { this.filterExt = v; return this; }
        public Builder minSizeBytes(Long v)          { this.minSizeBytes = v; return this; }
        public Builder modifiedAfterEpoch(Long v)    { this.modifiedAfterEpoch = v; return this; }
